/**
 * Created by kko on 2019-08-29.
 */
Ext.define('MyApp.lib.ux.ColorSelectionField', {
    ...
    beforeBodyEl: [
        '<div class="' + Ext.baseCSSPrefix + 'colorpicker-field-swatch" style="z-index: 10 !important">' +
