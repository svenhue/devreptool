...
*/
Ext.define('MyApp.model.tm.TMServiceProvider',
{
    ...
    fields: [
        ...
        {name: 'service_provider_ident', type: 'string', persist: false},
],

    validators: [
        {field: 'ident', type: 'presence'},
        {field: 'name_1', type: 'presence'},
        {field: 'city', type: 'presence'},
    ],

    proxy: {
        type: 'rest',
        url: '/api/tm/serviceproviders',
        reader: {
            type: 'json',
            rootProperty: 'data'
        }
