...
Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("reports/Arial.ttf", "Arial");
Stimulsoft.Base.Localization.StiLocalization.setLocalizationFile('reports/de.xml', true);
