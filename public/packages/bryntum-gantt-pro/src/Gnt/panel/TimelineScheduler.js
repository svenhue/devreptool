...
Ext.define("Gnt.panel.TimelineScheduler", {
    ...
    initComponent : function () {
        ...
        Ext.apply(me, {
            ...
            tooltipTpl : new Gnt.template.TaskTooltip(),
        ...
        me.on('resize', me.onSchedResize, me, { buffer : 50 });
    ...
    setTaskStore : function (taskStore, prevTaskStore) {
        ...
        var listeners = {
            ...
            rootchange : me.fillStoreFromTaskStore,
    ...
    eventRenderer : function (ev, resource, meta) {
        ...
        if (ev.isMilestone()) {
            return '<div class="sch-gantt-timeline-diamond"></div><div unselectable="on" class="sch-gantt-timeline-milestone-label">' + name + '</div>';
        } else {
    ...
    getAvailableRowHeight : function () {
        var normalBody = this.normalGrid.body; // WARNING: private

        return Ext.fly(normalBody).getHeight() - this.milestoneBottomPadding;
    }
});
