...
Ext.define('Gnt.model.Task', {
     ...
     * @propagating The method triggers propagation after changing the task.
     *
     * <br><br>
     * **Also please note:**
     *
     * - Calling this method does not guarantee the task will have that exact provided date.
     *   Task start date is a calculated value and might change depending on the task settings.
     *   See ["Automatic tasks scheduling"](#!/guide/gantt_scheduling) guide for details.
     * - When {@link Gnt.data.TaskStore#scheduleByConstraints scheduleByConstraints} is `true`
     *   the method forces the change by setting _Start No Earlier Than_ (_SNET_) constraint
     *   with the provided date (happens in a forward scheduled project only).
     * - When {@link Gnt.data.TaskStore#checkDependencyConstraint checkDependencyConstraint} is `true`
     *   the Gantt might show the dialog alerting a user when moving a task
     *   causes either a dependency breaking or making a dependency to not drive the task position'
     *   (happens in a forward scheduled project only).
     *   See {@link Gnt.constraint.implicit.Dependency} for details.
     *
     * @param {Date} date Start date to set
     * @param {Boolean} [keepDuration=true] Pass `true` to keep the task {@link #Duration duration} ("move" the task)
     * then its {@link #EndDate end date} will be recalculated.
     * And pass `false` to recalculate the {@link #Duration duration} keeping {@link #EndDate end date} intact ("resize" the task).
     *
     * **Please note** that for {@link #isEffortDriven effort driven} tasks this option is `false` by default.
     * @param {Boolean} [skipNonWorkingTime=taskStore.skipWeekendsDuringDragDrop]
     * Pass `true` to adjust the provided date to the **next** available working time, in case the date falls on non-working time.
     * **Please mind** the parameter default value is set to {@link Gnt.data.TaskStore#skipWeekendsDuringDragDrop skipWeekendsDuringDragDrop}
     * value.
    ...
    /**
     * Sets the task {@link #StartDate start date}.
     * The provided date value can be adjusted to match working time (defined by `skipNonWorkingTime` argument).
     * Depending on the `keepDuration` argument the method also changes either the task {@link #EndDate end date}
     * or {@link #Duration duration} (see the argument description for details).
     ...
     * **Also please note:**
     *
     * - Calling this method does not guarantee the task will have that exact provided end date.
     *   Task end date is a calculated value and might change depending on the task settings.
     *   See ["Automatic tasks scheduling"](#!/guide/gantt_scheduling) guide for details.
     *
     * @inheritdoc #setEndDateWithoutPropagation
     * @param {Date} date End date to set
     * @param {Boolean} [keepDuration=true] Pass `true` to keep the task {@link #Duration duration} ("move" the task)
     * then its {@link #StartDate start date} will be recalculated.
     * And pass `false` to recalculate the {@link #Duration duration} keeping {@link #StartDate start date} intact ("resize" the task).
     * @param {Boolean} [skipNonWorkingTime=taskStore.skipWeekendsDuringDragDrop]
     * Pass `true` to adjust the provided date to the **previous** available working time, in case the date falls on non-working time.
     * **Please mind** the parameter default value is set to {@link Gnt.data.TaskStore#skipWeekendsDuringDragDrop skipWeekendsDuringDragDrop}
     * value.
    ...
    /**
     * Sets the task {@link #EndDate end date}.
     * The provided date value can be adjusted to match working time (defined by `skipNonWorkingTime` argument).
     * Depending on the `keepDuration` argument the method also changes either the task {@link #StartDate start date}
     * or {@link #Duration duration} (see the argument description for details).
     * The modifications are wrapped with `beginEdit/endEdit` calls.
     *
     * @param {Date} date End date to set
     ...
     * **Also please note:**
     *
     * - Calling this method does not guarantee the task will have that exact provided dates.
     *   Task start and end dates are calculated values and might change depending on the task settings.
     *   See ["Automatic tasks scheduling"](#!/guide/gantt_scheduling) guide for details.
     * - When {@link Gnt.data.TaskStore#scheduleByConstraints scheduleByConstraints} is `true`
     *   the method forces the start date change by setting _Start No Earlier Than_ (_SNET_) constraint
     *   with the provided date (happens in a forward scheduled project only).
     * - When {@link Gnt.data.TaskStore#checkDependencyConstraint checkDependencyConstraint} is `true`
     *   the Gantt might show the dialog alerting a user when moving a task
     *   causes either a dependency breaking or making a dependency to not drive the task position'
     ...
     * @param {Boolean} [skipNonWorkingTime=taskStore.skipWeekendsDuringDragDrop]
     * Pass `true` to adjust the provided dates to match the task available working time.
     * The provided `startDate` and `endDate` values will be shifted respectively
     * to the **next** and **previous** available working time.
     * **Please mind** the parameter default value is set to {@link Gnt.data.TaskStore#skipWeekendsDuringDragDrop skipWeekendsDuringDragDrop}
     * value.
    ...
    /**
     * Sets the task {@link #StartDate start date} and {@link #EndDate end date}.
     * The method also recalculates the task {@link #Duration duration}.
     * The provided date values can be adjusted to match working time (defined by `skipNonWorkingTime` argument).
     * The modifications are wrapped with `beginEdit/endEdit` calls.
     *
     * @param {Date} startDate Start date to set
     * @param {Date} endDate End date to set
    ...
    /**
     * Calculates the task start date based on the provided end date and duration.
     * @param {Date} endDate End date.
     * @param {Number} duration Duration.
     * @param {String} [unit] Duration unit (the task {@link #durationUnit duration unit} by default).
     * @return {Date} Calculated start date.
     */
    ...
    /**
     * Calculates the task end date based on the provided start date and duration.
    ...
    /**
     * Calculates the task duration between the provided start and end dates.
     * @param {Date} startDate Start date.
     * @param {Date} endDate End date.
     * @param {String} [unit] Unit to calculate duration in (the task {@link #durationUnit duration unit} by default).
     * @return {Number} Calculated duration.
     */
