...
Ext.define('Gnt.data.TaskStore', {
    ...
    */
    ...
    /**
     * @cfg {Boolean} useManuallyScheduledTasksDatesAsLateDates
     * The config affects {@link Gnt.model.Task#isManuallyScheduled manually scheduled} tasks late dates calculation.
     * When the config is `true` such tasks late {@link Gnt.model.Task#getLateStartDate start}/{@link Gnt.model.Task#getLateEndDate end}
     * dates are taken from the tasks {@link Gnt.model.Task#getStartDate start}/{@link Gnt.model.Task#getEndDate end} dates respectively.
     */
    useManuallyScheduledTasksDatesAsLateDates : false,
