...
class HVReportController extends Controller
{
    public function all(Request $request)
    {
        $query = DB::table('hv_report')->select()
            ->where('hv_report.hv_company_id', $request->current_company_id)
    ...
    public function createOrUpdate(Request $request, $id = null)
    {
        ...
        if (Utils::alreadyExists(HVReport::class, $request->current_company_id, 'ident', $obj->ident, $obj->id)) {
