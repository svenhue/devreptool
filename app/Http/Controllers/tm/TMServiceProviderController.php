...
use App\Models\tm\TMServiceProvider;
use App\Utils\Utils;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class TMServiceProviderController extends Controller
{
    public function all(Request $request)
    {
        $query = TMServiceProvider::select()->where('tm_service_provider.hv_company_id', $request->current_company_id);
    ...
    public function createOrUpdate(Request $request, $id = null)
    {
        ...
        if ($id) {
            $obj = TMServiceProvider::find($id);
            $obj->updated_by = $request->current_user_id;
        } else {
            $obj = new TMServiceProvider();
        ...
        if (Utils::alreadyExists(TMServiceProvider::class, $request->current_company_id,'ident', $obj->ident, $obj->id)) {
