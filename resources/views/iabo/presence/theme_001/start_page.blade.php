            ...
            <div class="u-custom-menu u-nav-container">
                <ul class="u-nav u-unstyled u-nav-1">
                    <li class="u-nav-item"><a
                                ...
                                href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_Start}}{{$urlQuery}}@endif" style="padding: 10px 20px;">Startseite</a>
                    </li>
                    <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-60 u-text-hover-palette-2-base"
                                href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_Impressum}}{{$urlQuery}}@endif" style="padding: 10px 20px;">Impressum</a>
                    </li>
                    <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-60 u-text-hover-palette-2-base"
                                href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_Datenschutz}}{{$urlQuery}}@endif"
                                style="padding: 10px 20px;">Datenschutzvereinbarung</a>
                    </li>
                    <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-60 u-text-hover-palette-2-base"
                                href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_AGBs}}{{$urlQuery}}@endif" style="padding: 10px 20px;">AGB's</a>
                    </li>
                </ul>
            </div>
            <div class="u-custom-menu u-nav-container-collapse">
                <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav u-sidenav-1"
                    ...
                    <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                        <li class="u-nav-item"><a class="u-button-style u-nav-link" href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_Start}}{{$urlQuery}}@endif"
                                                  style="padding: 10px 20px;">Startseite</a>
                        </li>
                        <li class="u-nav-item"><a class="u-button-style u-nav-link" href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_Impressum}}{{$urlQuery}}@endif"
                                                  style="padding: 10px 20px;">Impressum</a>
                        </li>
                        <li class="u-nav-item"><a class="u-button-style u-nav-link" href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_Datenschutz}}{{$urlQuery}}@endif"
                                                  style="padding: 10px 20px;">Datenschutzvereinbarung</a>
                        </li>
                        <li class="u-nav-item"><a class="u-button-style u-nav-link" href="@if($viewType=='preview')#@else/{{$presenceObj->Seite_AGBs}}{{$urlQuery}}@endif"
